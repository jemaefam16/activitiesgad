...
<?php require_once('inc/header.php') ?>
  <body class="layout-fixed layout-footer-fixed text-sm sidebar-mini control-sidebar-slide-open layout-navbar-fixed " data-new-gr-c-s-check-loaded="14.991.0" data-gr-ext-installed="" style="height: auto;">
    ...
    <div class="modal-dialog modal-md modal-dialog-centered" role="document">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-primary" id='confirm' onclick="" style="background-color:blue;">Continue</button>
  ...
  <div class="modal fade" id="viewer_modal" role='dialog'>
    <div class="modal-dialog modal-md" role="document">
      <div class="modal-content">
              <button type="button" class="btn-close" data-dismiss="modal" style="background-color:red;"><span class="fa fa-times"></span></button>
              <img src="" alt="">
      </div>
    </div>
  </div>
